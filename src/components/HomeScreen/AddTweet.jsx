...
const AddTweet = (props) => {
  ...
  return (
    <div className='bg-white dark:bg-black border border-gray-200  dark:border-gray-700'>
        <div className="flex justify-between px-4 mt-2">
            <h2 className='font-bold text-xl font-sans'>Home</h2>
            <button onClick={() => handleIsDark()}>
            <svg className='hover:bg-gray-200 dark:bg-white cursor-pointer px-2 rounded-full' viewBox="0 0 24 24" width="40px" height="40px" aria-hidden="true"><g><path d="M22.772 10.506l-5.618-2.192-2.16-6.5c-.102-.307-.39-.514-.712-.514s-.61.207-.712.513l-2.16 6.5-5.62 2.192c-.287.112-.477.39-.477.7s.19.585.478.698l5.62 2.192 2.16 6.5c.102.306.39.513.712.513s.61-.207.712-.513l2.16-6.5 5.62-2.192c.287-.112.477-.39.477-.7s-.19-.585-.478-.697zm-6.49 2.32c-.208.08-.37.25-.44.46l-1.56 4.695-1.56-4.693c-.07-.21-.23-.38-.438-.462l-4.155-1.62 4.154-1.622c.208-.08.37-.25.44-.462l1.56-4.693 1.56 4.694c.07.212.23.382.438.463l4.155 1.62-4.155 1.622zM6.663 3.812h-1.88V2.05c0-.414-.337-.75-.75-.75s-.75.336-.75.75v1.762H1.5c-.414 0-.75.336-.75.75s.336.75.75.75h1.782v1.762c0 .414.336.75.75.75s.75-.336.75-.75V5.312h1.88c.415 0 .75-.336.75-.75s-.335-.75-.75-.75zm2.535 15.622h-1.1v-1.016c0-.414-.335-.75-.75-.75s-.75.336-.75.75v1.016H5.57c-.414 0-.75.336-.75.75s.336.75.75.75H6.6v1.016c0 .414.335.75.75.75s.75-.336.75-.75v-1.016h1.098c.414 0 .75-.336.75-.75s-.336-.75-.75-.75z"></path></g></svg>
       
            </button>
             </div>

        <div className="flex px-5 gap-3">
            <div className=""><img src="https://picsum.photos/60/60" className='rounded-full' alt="" /></div>

             <textarea name="" placeholder='What`s happening?' className='dark:bg-gray-800 w-full text-xl font-sans font-medium  mt-2 placeholder:text-gray-400 focus:outline-none placeholder:text-xl border-b-2 dark:border-gray-800' id="" cols="30" rows="3" ></textarea> 
            
        </div>

        <div className="flex h-5  px-12 justify-between  items-center py-8">
              <div className="flex gap-2 ml-12 h-5 ">
                  <svg viewBox="0 0 24 24" aria-hidden="true" className='cursor-pointer' fill='skyblue'><g><path d="M19.75 2H4.25C3.01 2 2 3.01 2 4.25v15.5C2 20.99 3.01 22 4.25 22h15.5c1.24 0 2.25-1.01 2.25-2.25V4.25C22 3.01 20.99 2 19.75 2zM4.25 3.5h15.5c.413 0 .75.337.75.75v9.676l-3.858-3.858c-.14-.14-.33-.22-.53-.22h-.003c-.2 0-.393.08-.532.224l-4.317 4.384-1.813-1.806c-.14-.14-.33-.22-.53-.22-.193-.03-.395.08-.535.227L3.5 17.642V4.25c0-.413.337-.75.75-.75zm-.744 16.28l5.418-5.534 6.282 6.254H4.25c-.402 0-.727-.322-.744-.72zm16.244.72h-2.42l-5.007-4.987 3.792-3.85 4.385 4.384v3.703c0 .413-.337.75-.75.75z"></path><circle cx="8.868" cy="8.309" r="1.542"></circle></g></svg>

                  <svg viewBox="0 0 24 24" aria-hidden="true" className='cursor-pointer'  fill='skyblue' class="r-1cvl2hr r-4qtqp9 r-yyyyoo r-z80fyv r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-19wmn03"><g><path d="M19 10.5V8.8h-4.4v6.4h1.7v-2h2v-1.7h-2v-1H19zm-7.3-1.7h1.7v6.4h-1.7V8.8zm-3.6 1.6c.4 0 .9.2 1.2.5l1.2-1C9.9 9.2 9 8.8 8.1 8.8c-1.8 0-3.2 1.4-3.2 3.2s1.4 3.2 3.2 3.2c1 0 1.8-.4 2.4-1.1v-2.5H7.7v1.2h1.2v.6c-.2.1-.5.2-.8.2-.9 0-1.6-.7-1.6-1.6 0-.8.7-1.6 1.6-1.6z"></path><path d="M20.5 2.02h-17c-1.24 0-2.25 1.007-2.25 2.247v15.507c0 1.238 1.01 2.246 2.25 2.246h17c1.24 0 2.25-1.008 2.25-2.246V4.267c0-1.24-1.01-2.247-2.25-2.247zm.75 17.754c0 .41-.336.746-.75.746h-17c-.414 0-.75-.336-.75-.746V4.267c0-.412.336-.747.75-.747h17c.414 0 .75.335.75.747v15.507z"></path></g></svg>
              ...
              <div className="bg-blue-500 text-lg font-normal py-1  hover:bg-blue-600 text-white items-center px-4  text-center cursor-pointer rounded-full ">
            Tweet
        </div>
              </div>
        </div>
        <div className="border hover:bg-gray-200 dark:border-gray-700 border-t-2 justify-center items-center text-center py-3 text-blue-600 cursor-pointer font-sans   dark:hover:bg-gray-900">
             show 556 tweets
        </div>
    </div>
  )
